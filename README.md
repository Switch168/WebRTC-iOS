...
5. Swift v 5 set
6. Copy over icons ``` cp -a plugins/webrtc-ios/WebRTC-Demo-App/Sources/Screens/VideoScreen/CDVWebRTCiOS.xcassets/*.imageset platforms/ios/{projectname}/Images.xcassets/  ```
